...
Historical benchmarks with the files included in Cédric Louvrier's [PNG Test Corpus](https://css-ig.net/png-tools-overview) versus (in some cases) previous versions of other commonly used PNG optimization software are available in [BENCHMARKS.md](BENCHMARKS.md).
